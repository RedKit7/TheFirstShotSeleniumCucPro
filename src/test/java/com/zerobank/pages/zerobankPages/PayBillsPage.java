...
public class PayBillsPage {
    ...
    public PayBillsPage(){
        ...
        public WebElement getYearStatement(String year){
            return Driver.get().findElement(By.xpath("//div[@class='pull-left']//ul//li//a[.='"+year+"']"));
        }
        public List<WebElement> getAllStatements(String year){
            return Driver.get().findElements(By.xpath("//div[@id='os_"+year+"']//tr//td[1]/a"));
        }
        public WebElement statement(String statement){
            return Driver.get().findElement(By.xpath("//div[@id='os_']//tr//td[1]/a"));
        }
